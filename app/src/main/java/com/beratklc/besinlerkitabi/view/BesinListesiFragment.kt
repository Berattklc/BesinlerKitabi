...
import com.beratklc.besinlerkitabi.adapter.BesinRecyclerAdapter
import com.beratklc.besinlerkitabi.model.Besin
import com.beratklc.besinlerkitabi.viewModel.BesinListesiViewModel
    ...
    fun observeLiveData(){
        ...
        viewModel.besinYukleniyor.observe(viewLifecycleOwner, Observer { yukleniyor ->
            yukleniyor?.let {
                if (it){
                    besinListRecycler.visibility = View.GONE
                    besinHataMesaji.visibility = View.GONE // bU ZATEN FALSE DA NEDEN BİR DAHA YAZDIK
                    besinYukleniyor.visibility = View.VISIBLE
                }else{
